...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 13. Jun 2024 um 20:21
...
('root', '[{\"db\":\"studienarbeit\",\"table\":\"scores\"},{\"db\":\"studienarbeit\",\"table\":\"players\"}]');
...
('root', '2024-06-13 18:20:59', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"de\"}');
...
--
CREATE DATABASE IF NOT EXISTS `studienarbeit` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `studienarbeit`;
...
--
ALTER TABLE `scores`
  ADD PRIMARY KEY (`id`,`world`,`level`);
